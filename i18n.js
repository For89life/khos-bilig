...
(function(){
  var DICT = {
"ТӨГС ҮЙЛЧИЛГЭЭГ БИД ТҮҮЧЭЭЛНЭ": "WE PIONEER FLAWLESS SERVICE",
...
"Даатгалын байгууллагатай хамтран ажилладаг бөгөөд хамгаалалтын албаны буруугаас хохирол учирсан нь тогтоогдвол 90 хүртэлх хувийг барагдуулна.": "We work with an insurance provider: if damage is found to have been caused by our security service, up to 90% of it is compensated.",
"Хохирлын 90 хүртэлх хувийг барагдуулах эрсдэл хариуцах тогтолцоо": "A liability system covering up to 90% of damages",
"Гуравдагч этгээдийн өмнө үүсэж болзошгүй хохирлын эрсдэлийг бууруулах зорилгоор бид «Мөнх Даатгал» ХХК-тай «Ерөнхий хариуцлагын даатгалын гэрээ» байгуулан ажилладаг. Гуравдагч этгээдийн амь нас, эрүүл мэнд, эд хөрөнгөд учирсан эрсдэлийг хариуцаж, хамгаалалтын албаны буруугаас хохирол учирсан нь тогтоогдвол хохирлын 90 хүртэлх хувийг барагдуулна.": "To reduce the risk of damage to third parties we maintain a General Liability Insurance Agreement with Munkh Insurance LLC. It covers risks to the life, health and property of third parties: where damage is found to have been caused by our security service, up to 90% of it is compensated.",
"Улаанбаатар дүүргийн бүсүүд": "Zones of Ulaanbaatar districts",
"Хүсэлтэд 24 цагийн дотор хариу өгнө.": "We reply to enquiries within 24 hours.",
...
"Мэдээ мэдээлэл": "News",
"Нүүр": "Home",
"Хамгаалалтын газар": "Security units",
...
"Хамтрагч байгууллагууд": "Partner organisations",
...
"Даатгалтай хамгаалалтын алба": "Insured security service",
"Хохирлыг": "We cover damages",
"80% хүртэл барагдуулна": "of up to 80%",
"Даатгалын байгууллагатай хамтран ажилладаг бөгөөд хамгаалалтын албаны буруугаас хохирол учирсан нь тогтоогдвол 80 хүртэлх хувийг барагдуулна.": "We work with an insurance provider: if damage is found to have been caused by our security service, up to 80% of it is compensated.",
...
"дахь жилдээ": "years",
"«Хос Билиг Секьюрити» ХХК нь Монгол Улсын Үндсэн хууль, «Гэрээт харуул хамгаалалтын тухай» хууль болон холбогдох бусад эрх зүйн актуудыг үйл ажиллагаандаа чанд мөрдлөг болгон хэрэгжүүлдэг, харуул хамгаалалтын салбарт 8 дахь жилдээ тогтвортой, тасралтгүй үйл ажиллагаа явуулж буй мэргэжлийн байгууллага юм.": "Khos Bilig Security LLC is a professional organisation that strictly observes the Constitution of Mongolia, the Law on Contract Guarding and Security and other related legal acts, and that has operated steadily and without interruption in the security industry for eight years.",
...
"Сүүлийн 4 жилийн хугацаанд манай хамт олон өндөр эрсдэлтэй, өндөр зэрэглэлийн хамгаалалт шаардсан объектууд болох уул уурхайн олборлолт, боловсруулах үйлдвэр, нүүрсний кемп, бизнесийн төвүүдэд тусгайлсан хамгаалалтын үйлчилгээ үзүүлж, найдвартай түнш гэдгээ батлан харуулсаар байна.": "Over the past four years our team has provided dedicated security at high-risk, high-grade sites — mining operations, processing plants, coal camps and business centres — proving itself a dependable partner.",
...
"Хохирлын 80 хүртэлх хувийг барагдуулах эрсдэл хариуцах тогтолцоо": "A liability system covering up to 80% of damages",
...
"нэгдсэн операторын хяналт": "central operator monitoring",
"Үйл ажиллагааны": "Our",
"чиглэл": "services",
...
"Хотын төв бүсийн объект, байгууллагуудын хамгаалалтыг хариуцан зохион байгуулна.": "Responsible for guarding facilities and organisations in the city's central zone.",
"Баруун бүс": "Western zone",
"Баруун бүсийн объект, байгууллагуудын хамгаалалтыг хариуцан зохион байгуулна.": "Responsible for guarding facilities and organisations in the western zone.",
"Зүүн бүс": "Eastern zone",
"Зүүн бүсийн объект, байгууллагуудын хамгаалалтыг хариуцан зохион байгуулна.": "Responsible for guarding facilities and organisations in the eastern zone.",
...
"400 мегапикселийн суурин болон бөмбөгөр хос камерын дүрсийг нэгтгэн өндөр нарийвчлалтай дүрс гаргана.": "A dual 400-megapixel fixed and dome camera pair merges its images into one high-resolution picture.",
...
"Хариуцлага нь": "Protection with",
"баталгаажсан хамгаалалт": "guaranteed liability",
"Гуравдагч этгээдийн өмнө үүсэж болзошгүй хохирлын эрсдэлийг бууруулах зорилгоор бид «Мөнх Даатгал» ХХК-тай «Ерөнхий хариуцлагын даатгалын гэрээ» байгуулан ажилладаг. Гуравдагч этгээдийн амь нас, эрүүл мэнд, эд хөрөнгөд учирсан эрсдэлийг хариуцаж, хамгаалалтын албаны буруугаас хохирол учирсан нь тогтоогдвол хохирлын 80 хүртэлх хувийг барагдуулна.": "To reduce the risk of damage to third parties we maintain a General Liability Insurance Agreement with Munkh Insurance LLC. It covers risks to the life, health and property of third parties: where damage is found to have been caused by our security service, up to 80% of it is compensated.",
...
"Тусгайлсан хамгаалалт шаардсан өндөр зэрэглэлийн объектууд дээр ажилласан туршлага": "Experience at high-grade sites requiring dedicated protection",
"Тасралтгүй хяналт, шуурхай удирдлага бүхий зохион байгуулалт": "An organisation built on continuous monitoring and responsive command",
"Даатгалын хамгаалалттай, эрсдэл хариуцах чадвартай систем": "An insured system able to carry liability",
"Итгэл хүлээлгэн хамтран ажилладаг": "Organisations that place their",
"байгууллагууд": "trust in us",
"Манай компанид итгэл хүлээлгэн хамтран ажилладаг байгууллагууд нь салбартаа тэргүүлэгч, өндөр шаардлага бүхий байгууллагууд бөгөөд бид тэдний итгэлийг бодит үр дүнгээр баталгаажуулж ирсэн.": "The organisations that entrust their security to us are leaders in their fields with demanding requirements, and we have justified their trust with real results.",
...
"Худалдааны төв": "Shopping centre",
"Хиймэл оюунд суурилсан эрт илрүүлгийн төв": "AI-based early-detection centre",
"Zint Pharm — эм, эмийн бүтээгдэхүүн": "Zint Pharm — pharmaceuticals",
"Ноолуурын үйлдвэр": "Cashmere factory",
"Энтертайнмент төв": "Entertainment centre",
...
"Худалдаа үйлчилгээний төвийн хамгаалалт": "Shopping and service centre security",
...
"Шинэ харуулын бүрэлдэхүүнд зориулсан хоёр долоо хоногийн сургалтыг амжилттай зохион байгуулав.": "A two-week training programme for the new guard intake was held successfully.",
...
"Хамгаалалтын шийдлээ": "Let's discuss your security",
"ярилцъя": "solution",
...
"Харуул хамгаалалтын салбарт 8 дахь жилдээ тогтвортой ажиллаж буй мэргэжлийн байгууллага. MNS 6908:2021 стандартын хэрэгжүүлэлт, даатгалтай хамгаалалтын алба.": "A professional organisation in its eighth year of steady work in the security industry. Implementing MNS 6908:2021, with an insured security service.",
...
"Алба хаагч худалдааны төвийн танхимд ээлжийн үүрэг гүйцэтгэж, үйлчлүүлэгчдийн аюулгүй байдлыг хангаж байна.": "An officer on shift duty in the shopping centre hall, keeping customers safe.",
...
"Албаны бэлэн байдал": "Service readiness",
...
"Худалдааны төвийн хамгаалалт": "Shopping centre security",
...
"Зочид буудал, амралтын газар, худалдааны төвийн үйлчлүүлэгчид болон эд хөрөнгийн аюулгүй байдлыг хангана.": "We keep guests, customers and property safe at hotels, resorts and shopping centres.",
